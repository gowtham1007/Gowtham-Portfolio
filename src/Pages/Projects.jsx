...
// const CuratedWorkGallery = () => {
//   return (
//     <div className="w-full bg-white px-4 sm:px-6 lg:px-8 py-16 overflow-x-hidden">
//       <motion.h1
//         className="text-4xl font-bold text-center mb-12 text-purple-700"
...
import uyir2 from "../assets/uyir2.jpeg";
...
import rail1 from "../assets/Rail1.jpg";
import rail2 from "../assets/rail2.jpg";
import rail3 from "../assets/Rail3.jpg";
...
import intern3 from "../assets/intern 3.jpg"; // Make sure you renamed it
